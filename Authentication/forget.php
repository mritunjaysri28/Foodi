	...
	<div class="container" style="width:100%;">
        ...
        <div class="col-md-9 col-sm-7" style="width:100%;">
            ...
            <div class="content-form-page" style="width:100%;">
				<center><div id="result" style="width:30%; height:auto; background-color:#00ffbf; align:center;"><?php echo $_SESSION['reg'];?></div>
				<form method="post" class="form-horizontal form-without-legend">
					<div class="form-group">
						<label class="control-label" for="email"><h3>If you have forgot or change your password you can reset it here.</h3></label>
						<div class="">
							<input type="email" style="width:70%; color:black;" placeholder="Enter register email" name="email" class="form-group" required />
						</div>
					</div>
					<div class="row">
						<div class="col-lg-8 col-md-offset-2 padding-left-0 padding-top-20">
							<button type="submit" name="forge" class="btn btn-primary" >SUBMIT</button>
						</div>
					</div>
				</form></center>
            </div>
